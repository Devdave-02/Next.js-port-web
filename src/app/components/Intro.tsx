  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0 w-full md:flex-[0.45] md:max-w-[500px] md:mx-0">
        <pre className="font-mono text-[10px]  min-[500px]:text-[10] min-[500px]:max-w-[500px] sm:text-[12px] sm:max-w-[500px]  md:text-[13px] bg-[rgba(30,30,60,1)] py-[30px] pl-[20px] pr-0 rounded-[8px] leading-[1.9] text-left text-[#ffd700] max-w-[470px] md:text-[0.8rem] md:py-4 md:px-4 md:max-w-[500px] md:mx-auto">
          {`const coder = {
