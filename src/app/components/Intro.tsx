...
function Intro() {
  ...
  return (
    <section
      id="Intro"
      className="mt-[100px]  flex flex-col-reverse sm:flex md:flex-row justify-between items-center gap-0 mx-auto  max-w-[1200px] px-4"
    >
      {/* Left div */}
      <div className="p-[20px] shadow-lg text-[#f0f8ff] min-[500px]:text-[20px] min-[500px]:w-[500px]  sm:text-[17px] sm:w-[500px]  flex-shrink-0 md:flex-[0.55]  md:max-w-[600px] sm:px-0 md:p-6 md:text-[23px] md:mx-0 md:flex md:flex-col md:items-start">
        <div className="text-left md:text-left">
          <p className=" text-[23px] md:text-[45px] ">
            Hello, I am{" "}
            <strong className="text-[#FFD700] text-[28px]  min-[500px]:text-[32px]  sm:text-[36px] md:text-[50px] font-extraboldmd:font-extrabold block">
              <i>David Okanlawon,</i>
            </strong>{" "}
            A professional{" "}
      ...
      <div className="flex-shrink-0 w-full md:flex-[0.45] md:max-w-[500px] md:mx-0">
        <pre className="font-mono text-[10px]  min-[500px]:text-[10] min-[500px]:max-w-[500px] sm:text-[12px] sm:max-w-[500px]  md:text-[13px] bg-[rgba(30,30,60,1)] py-[30px] pl-[20px] pr-0 rounded-[8px] leading-[1.9] text-left text-[#ffd700] max-w-[470px] md:py-4 md:px-4 md:max-w-[500px] md:mx-auto">
          {`const coder = {
